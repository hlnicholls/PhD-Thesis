...
dataset = pd.read_csv("lipids_total_training_TPMFC.txt", sep="\t")
...
df = df.drop(["label", "Gene_length", "CADD_RAW", "gwastrait",'ExomiserScore',
...
dt_towrite["label"] = dataset["label"]
dt_towrite = dt_towrite.drop(["label_encoded"], 1)
