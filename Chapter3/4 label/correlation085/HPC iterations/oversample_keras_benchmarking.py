...
data['BPlabel_encoded'] = data['BPlabel'].map( {'most likely':0,'probable':1, 'possible':2, 'least likely': 3})
...
print("After OverSampling, counts of label '1': {}".format(sum(Y==0)))
print("After OverSampling, counts of label '2': {}".format(sum(Y==1)))
print("After OverSampling, counts of label '3': {}".format(sum(Y==2)))
print("After OverSampling, counts of label '4': {}".format(sum(Y==3)))
